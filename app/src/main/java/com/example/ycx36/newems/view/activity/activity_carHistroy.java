    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.RL_1:
                ...
                break;
            case R.id.RL_2:
                startActivity(new Intent(activity_carHistroy.this,activity_from_carHistory_mcu.class));
                break;
            case R.id.RL_3:

                break;
            case R.id.RL_4:
                startActivity(new Intent(activity_carHistroy.this,activity_from_carHistory_vcu.class));
                break;
